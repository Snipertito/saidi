...
sudo_users = {SUDO,968613145,968613145,968613145,968613145}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'تيتو'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
send(msg.chat_id_, msg.id_,' ✯ تم تحديث السورس \n ✯ لديك اخر اصدار لسورس تيتو\n ✯ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✯ اصدار سورس تيتو\n ✯ الاصدار »{ v 1.5}')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 Tito 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/e2_c11"}},
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 ASALIYA 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/AsaliyaEgypt"}},
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 ALHRAM🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/MAHMOUD_ALHARAM"}},
...
if text == 'مبرمج تيتو' or text == 'توت' or text == 'البابا' then
local Text = [[
[DEV Tito](t.me/e2_c11)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 Tito🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/e2_c11"}},
...
if text == 'تيتو مصر' or text == 'تيتو' or text == 'تيتو اوفلاين ' then
local Text = [[
[DEV Tito](t.me/e2_c11)
]]
keyboard = {} 
...
if text == 'عمو تيتو' or text == 'تيتو' or text == 'مبرمج' then
local Text = [[
DEV Tito
]]
keyboard = {} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗧𝘄𝗮𝘀𝗼𝗹', url="t.me/e2_c11_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_, " ✯ لا يمكنك حظر المبرمج تيتو \n")
return false 
end
if result.sender_user_id_ == tonumber(968613145) then
...
if tonumber(result.id_) == tonumber(968613145) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع حظر المبرمج تيتو  عام")
return false 
end
...
if result.sender_user_id_ == tonumber(968613145) then
send(msg.chat_id_, msg.id_, " ✯ لا يمكنك كتم المبرمج تيتو \n")
return false 
end
if result.sender_user_id_ == tonumber(968613145) then
...
if tonumber(result.id_) == tonumber(968613145) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع كتم المبرمج تيتو  عام")
return false 
end
if tonumber(result.id_) == tonumber(968613145) then  
...
send(msg.chat_id_, msg.id_," ✯ عذرا الملف لايدعم سورس تيتو\n") 
end
return false
end
...
if text == ("مسح قائمه تيتو") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✯ تم مسح قائمه تيتو')
return false
end

if text == 'قائمه تيتو' and Sudo(msg) then
...
if text == ("رفع تيتو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع تيتو@(.*)$") and Sudo(msg) then
local username = text:match("^رفع تيتو@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع تيتو(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع تيتو(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل تيتو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل تيتو@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل تيتو@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل تيتو(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل تيتو(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيتو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تيتو')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس تيتويعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيتو').." غادر" or text == 'غادر' then  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تيتو')
